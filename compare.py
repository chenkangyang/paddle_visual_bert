...
import paddle
from PaddleNLP.paddlenlp.transformers import BertTokenizer as PDBertTokenizer, VisualBertForQuestionAnswering as PDVisualBertForQuestionAnswering
import numpy as np

torch_model = PTVisualBertForQuestionAnswering.from_pretrained("/home/chenkangyang/workspace/paddle_visual_bert/models/uclanlp/visualbert-vqa")
torch_tokenizer = PTBertTokenizer.from_pretrained("/home/chenkangyang/workspace/paddle_visual_bert/models/bert-base-uncased")
torch_model.eval()
...
paddle_model = PDVisualBertForQuestionAnswering.from_pretrained('visualbert-vqa', num_classes=3129)
