...
from paddlenlp.transformers import (BertTokenizer, LinearDecayWithWarmup, VisualBertForPreTraining)

FORMAT = '%(asctime)s-%(levelname)s: %(message)s'
logging.basicConfig(level=logging.INFO, format=FORMAT)
logger = logging.getLogger(__name__)

MODEL_CLASSES = {"visualbert": (VisualBertForPreTraining, BertTokenizer), }
