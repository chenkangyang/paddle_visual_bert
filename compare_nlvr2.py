...
paddle_model_name = "visualbert-nvlr2"

# torch output
import torch
from transformers import BertTokenizer as PTBertTokenizer, VisualBertForVisualReasoning as PTVisualBertForVisualReasoning

import paddle
from paddlenlp.transformers import BertTokenizer as PDBertTokenizer, VisualBertForVisualReasoning as PDVisualBertForVisualReasoning
import numpy as np

torch_model = PTVisualBertForVisualReasoning.from_pretrained(torch_model_name)
