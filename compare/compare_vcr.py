...
torch_model = PTVisualBertForMultipleChoice.from_pretrained("../checkpoint/" + torch_model_name)
torch_tokenizer = PTBertTokenizer.from_pretrained("../checkpoint/bert-base-uncased")
torch_model.eval()

torch_inputs = torch_tokenizer([[text, text], [choice0, choice1]], return_tensors="pt", padding="max_length", max_length=128)
